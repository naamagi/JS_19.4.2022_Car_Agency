...
const deleteCarFromAgency = carAgencyFunctions.deleteCarFromAgency;
...
test("deleteCarFromAgency example 1", () => {
  expect(deleteCarFromAgency(currentCarMarket, "Plyq5M5AZ", "2kjy7")).toBe();
});
